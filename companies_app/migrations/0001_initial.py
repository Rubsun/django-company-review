# Generated by Django 5.0.3 on 2024-05-23 10:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('street_name', models.TextField(max_length=255, verbose_name='street name')),
                ('city', models.TextField(max_length=50, verbose_name='city')),
                ('state', models.TextField(max_length=50, verbose_name='state')),
                ('house_number', models.PositiveIntegerField(default=None, verbose_name='house number')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='companies_app.address', verbose_name='adress')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='companies_app.client')),
                ('equipment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews', to='companies_app.equipment')),
            ],
            options={
